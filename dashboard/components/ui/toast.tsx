...
>(({ className, variant = 'default', ...props }, ref) => {
  const variantClasses = {
    ...
    destructive: 'destructive border-red-500 bg-red-500 text-red-50 dark:border-red-900 dark:bg-red-900 dark:text-red-50',
    success: 'border-green-500 bg-green-500 text-green-50 dark:border-green-900 dark:bg-green-900 dark:text-green-50'
  };
